...
const Navbar = () => {
  ...
  return (
    <nav className={styles.navbar}>
      ...
      <li>
        <Link href="/doctors" className={pathname === '/doctors' ? styles.active : ''}>Doctors</Link>
      </li>
      <li>
        <Link href="/create-doctor" className={pathname === '/create-doctor' ? styles.active : ''}>Create doctor</Link>
      </li>
      <li>
